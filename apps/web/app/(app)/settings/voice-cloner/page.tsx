  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-8">
      <header className="mb-6">
        <h1 className="text-xl font-semibold tracking-tight">Voice cloner</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="surface-card p-6">
          ...
          <h2 className="mt-4 text-[15px] font-semibold">Record / upload a voice note</h2>
        ...
        <div className="surface-card p-6">
          <span className="flex size-11 items-center justify-center rounded-xl bg-primary/[0.14] text-indigo-text">
            <Sparkles className="size-5" />
          </span>
          <h2 className="mt-4 text-[15px] font-semibold">AI voice clone</h2>
          <p className="mt-1 text-sm text-muted-foreground">
